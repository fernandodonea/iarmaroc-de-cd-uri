...
INSERT INTO COMANDA (comanda_id, utilizator_id, data_plasare, status, adresa_livrare, metoda_plata, cost_total, cost_transport)
VALUES (seq_comanda.NEXTVAL, 1, TO_DATE('2022-01-01', 'YYYY-MM-DD'), 'Livrată', 'Str. Lalelelor nr. 23, Roman, Neamt, 617466', 'Card', 104.98, 15.00);

INSERT INTO COMANDA (comanda_id, utilizator_id, data_plasare, status, adresa_livrare, metoda_plata, cost_total, cost_transport)
VALUES (seq_comanda.NEXTVAL, 2, TO_DATE('2021-05-02', 'YYYY-MM-DD'), 'Procesată', 'Str. Libertății, nr. 15, Cluj-Napoca, Cluj, 400000', 'Ramburs', 64.99, 15.00);

INSERT INTO COMANDA (comanda_id, utilizator_id, data_plasare, status, adresa_livrare, metoda_plata, cost_total, cost_transport)
VALUES (seq_comanda.NEXTVAL, 3, TO_DATE('2020-12-03', 'YYYY-MM-DD'), 'Expediată', 'Spl. Independentei, nr. 68, Bucuresti, Bucuresti, 700000', 'Card', 93.98, 15.00);

INSERT INTO COMANDA (comanda_id, utilizator_id, data_plasare, status, adresa_livrare, metoda_plata, cost_total, cost_transport)
VALUES (seq_comanda.NEXTVAL, 4, TO_DATE('2024-08-23', 'YYYY-MM-DD'), 'Plasată', 'Str. Tudor Arghezi, nr. 23, Iasi, Iasi, 300000', 'Card', 55.98, 15.00);

INSERT INTO COMANDA (comanda_id, utilizator_id, data_plasare, status, adresa_livrare, metoda_plata, cost_total, cost_transport)
VALUES (seq_comanda.NEXTVAL, 5, TO_DATE('2025-05-01', 'YYYY-MM-DD'), 'Anulată', 'Str. Avram Iancu nr. 30, Brașov, Brasov, 500000', 'Ramburs', 84.94, 15.00);
...
INSERT INTO ALBUM_GEN_MUZICAL (album_id, gen_id) VALUES (8, 100); -- Hot Space - Pop (acest album are elemente pop)
INSERT INTO ALBUM_GEN_MUZICAL (album_id, gen_id) VALUES (6, 100); -- Random Access Memories - Pop (are elemente pop)
